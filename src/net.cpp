...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Darecoin " + FormatFullVersion();
...
/*
static const char *strMainNetDNSSeed[][2] = {
    {"darecointools.com", "dnsseed.darecointools.com"},
    {"darecoinpool.org", "dnsseed.darecoinpool.org"},
    {"xurious.com", "dnsseed.drc.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"darecointools.com", "testnet-seed.darecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Darecoin is probably already running."), addrBind.ToString().c_str());
        else
